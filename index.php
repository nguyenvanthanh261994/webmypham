...
';
        ...
        <!--END ĐĂNG NHẬP-->
       	<div class="hotline">
            ...
            <div class="pdetail">0123456789 - 01568369368</div><!--pdetail-->
        </div><!--hotline-->
...
<div class="footer">
	<div class="homeEmail">
    	<div class="container">
        	<div class="connect">
            	KẾT NỐI VỚI MXH
                <a title="Facebook Nguyễn Văn Thành" href="https://www.facebook.com/thanh.nguyenvan.3382" rel="nofollow" target="_blank" class="fb"></a>
                <div class="backtop">
    				<b></b>
				</div><!--end backtop-->
    ...
    <div class="container">
        ...
        <div class="link call"> Tổng đài tư vấn bán hàng (7:30 - 22:00) hằng ngày<br/>
        	<span class="tongtaituphone">01658 369 368 (Thành)</span><!--end tongdaituphone--><br/>
            Điện thoại
            <span class="tongtaituphone">0123456789</span><!--end tongdaituphone--><br/>
            Giải quyết khiếu nại từ (9:00 - 17:00) hằng ngày
                    </div><!--end link call-->
    </div><!--end container footer-->
    <div class="clear"></div><!--end clear-->
    <div class="footerAdd"> © 2016. Công Ty Mỹ Phẩm<br/>
    Địa chỉ : Truong Dinh, Ha Noi, Viet Nam
